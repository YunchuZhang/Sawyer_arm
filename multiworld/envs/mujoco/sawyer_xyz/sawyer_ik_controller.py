...
Run `pip install pybullet==2.5.6`.
"""
...
try:
    ...
    raise Exception(
        "Please make sure pybullet is installed. Run `pip install pybullet==2.5.6`"
    )
from os.path import join as pjoin

import multiworld.envs.mujoco.sawyer_xyz.transform_utils as T
from multiworld.envs.mujoco.sawyer_xyz.controller import Controller
...
class SawyerIKController(Controller):
        ...
        if rest_poses is None:
            ik_solution = list(
                p.calculateInverseKinematics(
                    ...
                    restPoses=[1.7244448, -0.92036369,  0.10234232,  2.11178144,  2.97668632, -0.38664629, 0.54065733],
                    jointDamping=[0.1] * 7,
                )
            )
        else:
    ...
    def joint_positions_for_eef_command(self, dpos, rotation):
        ...
        rest_poses =[1.7244448, -0.92036369,  0.10234232,  2.11178144,  2.97668632, -0.38664629, 0.54065733]
